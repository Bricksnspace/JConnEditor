...
public class AboutDialog extends JDialog implements ActionListener {
	...
	public AboutDialog(JFrame owner, String title, ImageIcon icn) {
		...
		JLabel prog = new JLabel("JBrickConnEditor",SwingConstants.CENTER);
...
//		
//		prog = new JLabel(new ImageIcon(jbrickconn.class.getResource("images/rb-icon.png")));
//		prog.setBorder(BorderFactory.createLineBorder(Color.white, 3));
//		prog.setAlignmentX(Component.CENTER_ALIGNMENT);
//		body.add(prog);
//		
//		prog = new JLabel("<html><center>JBrickConnEditor is offered to the AFOL community<br/>by Romabrick people</center></html>",
...
//	    body.add(urlButton);
		...
		prog = new JLabel("<html><small>JBrickConnEditor is NOT related, linked,<br/>sponsored or supported by LEGO® Group</small></html>",
				SwingConstants.CENTER);
		prog.setAlignmentX(Component.CENTER_ALIGNMENT);
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if (ev.getSource() == okButton) {
			...
			JOptionPane.showMessageDialog(this,
					...
					new ImageIcon(jbrickconn.class.getResource("images/star.png")));
		}
//		else if (ev.getSource() == otherSoftware) {
//			JOptionPane.showMessageDialog(this,
//					"Other brick-related software:\n"
//					+ "-BrickUtils (http://www.romabrick.it/brickutils)\n"
//					+ "  Utilities for MOC builders with LDD, LDraw and BrickLink\n"
//					+ "-BrickMosaic (http://www.romabrick.it/brickmosaic)\n"
//					+ "  To transform your best photos to a mosaics of bricks",
//					"More brick software",
//					JOptionPane.INFORMATION_MESSAGE, 
//					new ImageIcon(jbrickconn.class.getResource("images/checked.png"))
//					);
//		}
	}
