...
public class LDrawPartChooser extends JDialog implements ActionListener, ListSelectionListener, DocumentListener {
	...
	public LDrawPartChooser(Frame owner, String title, boolean modal, LDrawDB db) {
		...
		JLabel l = new JLabel("<html><p>Search hints: "
				...
				+ "<p>'brick -duplo' exclude word 'Duplo'  "
				+ "'brick +axle' must include word 'axle'</p>"
				+ "");
		root.add(l,gbc);
		...
		catList = new JList<Object>(LDrawPartCategory.values());
		...
		updated = new JButton("Updated");
        buttonPane.add(updated);
